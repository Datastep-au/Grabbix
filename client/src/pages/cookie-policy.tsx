...
export default function CookiePolicy() {
  const cookieJsonLd = {
    ...
    description:
      "Cookie policy for Grabbix smart store solutions. Learn about cookies and tracking technologies we use.",
      ...
      <div className="pt-20 pb-16 bg-gray-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <h1 className="text-4xl font-bold text-grabbix-dark mb-8">
              Cookie Policy
            </h1>
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <h2 className="text-2xl font-semibold text-grabbix-dark mt-8 mb-4">
                What Are Cookies?
              </h2>
              <p className="mb-6">
                Cookies are small text files that are stored on your device when
                you visit our website. They help us understand how you interact
                with our site and improve your browsing experience.
              </p>
              ...
              <h3 className="text-xl font-semibold text-grabbix-dark mt-6 mb-3">
                Essential Cookies
              </h3>
              <p className="mb-4">
              ...
              <p className="mb-4">
                ...
                with our website. This helps us improve our website's
                performance and user experience. These cookies collect
                information such as:
              </p>
              ...
              <p className="mb-6">
                ...
                such as remembering your preferences and providing a more
              ...
              <p className="mb-6">
                ...
                help us analyze website traffic and improve our services. These
                partners have their own privacy policies and cookie practices.
              </p>
              ...
              <ul className="list-disc pl-6 mb-6">
                ...
                <li>
                  <strong>Third-Party Tools:</strong> Some third-party tools
                  allow you to manage cookie preferences across multiple
                  websites
                </li>
              </ul>
              ...
              <p className="mb-6">
                ...
                functionality of our website and your user experience. Essential
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p>
                  <strong>Email:</strong> info@grabbix.com.au
                </p>
              </div>
            </div>
          </div>
