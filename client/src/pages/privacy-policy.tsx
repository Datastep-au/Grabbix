...
export default function PrivacyPolicy() {
  const privacyJsonLd = {
    ...
    description:
      "Privacy policy for Grabbix smart store solutions. Learn how we collect, use, and protect your personal information.",
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                ...
                you fill out our contact form, request information about our
                smart store solutions, or communicate with us. This may include:
              </p>
              ...
              <p className="mb-6">
                ...
                your browser preferences. For more details, please see our
                Cookie Policy.
              </p>
