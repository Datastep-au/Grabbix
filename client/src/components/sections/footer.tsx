      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <Link href="/use-cases/offices" className="hover:text-grabbix-teal transition-colors duration-200">
                  Offices
                </Link>
              </li>
              <li>
                <Link href="/use-cases/apartments" className="hover:text-grabbix-teal transition-colors duration-200">
                  Apartments
                </Link>
              </li>
              <li>
                <Link href="/use-cases/coworking" className="hover:text-grabbix-teal transition-colors duration-200">
                  Co-working
                </Link>
              </li>
              <li>
                <Link href="/use-cases/gyms" className="hover:text-grabbix-teal transition-colors duration-200">
                  Gyms & Fitness
                </Link>
              </li>
              <li>
                <Link href="/use-cases/students" className="hover:text-grabbix-teal transition-colors duration-200">
                  Student Housing
                </Link>
              </li>
              <li>
                <Link href="/use-cases/healthcare" className="hover:text-grabbix-teal transition-colors duration-200">
                  Healthcare
                </Link>
              </li>
              <li>
                <Link href="/use-cases/hotels" className="hover:text-grabbix-teal transition-colors duration-200">
                  Hotels
                </Link>
              </li>
            </ul>
